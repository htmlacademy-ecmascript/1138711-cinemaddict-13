...
const generateRealize = (date) => {
  return dayjs().subtract(date, `year`).subtract(date, `month`).subtract(date, `day`).format(`DD MMM YYYY`);
};
...
const createFilmCardTemplate = (card) => {
  ...
  <p class="film-card__info">
    <span class="film-card__year">${generateRealize(date)}</span>
